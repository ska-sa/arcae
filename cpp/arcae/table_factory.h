...
arrow::Result<std::shared_ptr<NewTableProxy>> DefaultMS(
    ...
    const std::string& json_dminfo = "{}", const std::string& json_cache_size = "{}");
arrow::Result<std::shared_ptr<NewTableProxy>> CreateTable(
    const std::string& name, std::size_t ninstances = 1,
    const std::string& json_table_desc = "{}", const std::string& json_dminfo = "{}",
    std::size_t nrow = 0, const std::string& json_cache_size = "{}");
